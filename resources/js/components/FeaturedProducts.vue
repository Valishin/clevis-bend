        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div v-else ref="grid" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 divide-y sm:divide-y-0 sm:divide-x divide-brand-champagne border border-brand-champagne">
                <article
                    ...
                    :key="product.id"
                    data-reveal
                    class="group flex flex-col bg-brand-ivory hover:bg-white transition-all duration-300 shadow-[0_4px_24px_0_rgba(181,155,133,0.22)] hover:shadow-[0_12px_40px_0_rgba(181,155,133,0.38)]"
                >
                    <!-- Image / Swiper -->
            ...
            <div class="text-center mt-14">
                <CbButton href="/products" variant="outline">
                    View All Components
